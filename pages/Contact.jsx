  ...
  <>
    <section className="contact-section">
      ...
      <div className="contact-container">
        ...
        {/* Map below form */}
        <div className="contact-map" style={{ marginTop: '20px', height: '300px' }}>
          <iframe
      ...
      <div className="company-carousel">
        <div className="company-grid">
          <div className="company-card">
            ...
            <p>We source only the best spices directly from farmers.</p>
          </div>
          <div className="company-card">
            <h3>Global Reach</h3>
            <p>Supplying spices across 15+ countries.</p>
          </div>
          <div className="company-card">
            <h3>Fast Delivery</h3>
            <p>Ensuring freshness through quick logistics.</p>
          </div>
          <div className="company-card">
            <h3>Trusted By Chefs</h3>
            <p>Used by over 10,000 chefs worldwide.</p>
          </div>
        </div>
      </div>
    </section>
